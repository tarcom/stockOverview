...
$presets = [
  ...
  // --- Log-lineær vækst korreleret med S&P500 (det "stiger som en log-linje + følger markedet") ---
  'logcompounder' => ['label'=>'📈 Log-compounder vs S&P', 'sort'=>'quality_3y', 'dir'=>'desc',
    'title'=>'Stiger som en ren linje i log-skala OG hænger sammen med S&P500: høj trend-stabilitet (R²>0.88), markeds-korrelation (daglig R²>0.15), 3-års CAGR >12%, slår markedet (relativ styrke ≥0), large-cap, ≥5 års historik. Sorteret efter kvalitets-score.',
    'filters'=>['trend_r2_3y'=>['min'=>0.88],'mkt_r2_3y'=>['min'=>0.15],'rs_3y'=>['min'=>0],'cagr_3y'=>['min'=>0.12],'quality_3y'=>['min'=>0.2],'mkt_cap_usd'=>['min'=>1e9],'history_years'=>['min'=>5]]],
  'sptrackerplus' => ['label'=>'🧭 S&P-tracker+', 'sort'=>'rs_3y', 'dir'=>'desc',
    'title'=>'Markedslinket men slår indekset: stærk S&P500-korrelation (daglig R²>0.20), jævn stigning (trend-R²>0.80), positiv relativ styrke, 3-års CAGR >8%, begrænset drawdown, large-cap. Sorteret efter merafkast vs S&P500.',
    'filters'=>['mkt_r2_3y'=>['min'=>0.20],'trend_r2_3y'=>['min'=>0.80],'rs_3y'=>['min'=>0],'cagr_3y'=>['min'=>0.08],'maxdd_3y'=>['min'=>-0.45],'mkt_cap_usd'=>['min'=>1e9]]],
  'aggrlog' => ['label'=>'🚀 Aggressiv log-vækst', 'sort'=>'quality_3y', 'dir'=>'desc',
    'title'=>'Hurtigere, men stadig jævne compoundere: høj kvalitets-score (>0.7), trend-R²>0.85, 3-års CAGR >30%, slår markedet klart (relativ styrke >15%), mid/large-cap, ≥5 års historik. Sorteret efter kvalitets-score.',
    'filters'=>['quality_3y'=>['min'=>0.7],'trend_r2_3y'=>['min'=>0.85],'cagr_3y'=>['min'=>0.30],'rs_3y'=>['min'=>0.15],'mkt_cap_usd'=>['min'=>5e8],'history_years'=>['min'=>5]]],
    ...
    <div class="chartbox" id="chartbox">
      <div class="chart-controls">
        ...
        <span class="period-btns" id="periodBtns">
          <?php foreach (['1m'=>'1M','3m'=>'3M','6m'=>'6M','1y'=>'1Å','2y'=>'2Å','3y'=>'3Å','5y'=>'5Å','10y'=>'10Å','max'=>'Maks'] as $w=>$lbl): ?>
            <button type="button" class="pbtn<?= $w==='3y'?' on':'' ?>" data-win="<?= $w ?>"><?= $lbl ?></button>
          <?php endforeach; ?>
        </span>
        <select id="chartWindow" hidden>
          <?php foreach (['1m','3m','6m','1y','2y','3y','5y','10y','max'] as $w): ?>
...
<div id="stockModal" class="modal" hidden>
  <div class="modal-card">
    ...
    <div class="ta-controls">
      ...
      <span>Indikatorer
        <label><input type="checkbox" class="ta-sub" value="vol" checked> Volumen</label>
