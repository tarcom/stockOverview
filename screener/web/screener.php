...
$presets = [
  ...
  'logcompounder' => ['label'=>'📈 Log-compounder vs S&P', 'sort'=>'quality_3y', 'dir'=>'desc',
    'title'=>'Stiger som en ren linje i log-skala OG hænger sammen med S&P500: høj trend-stabilitet (R²>0.88), markeds-korrelation (R²>0.35), 3-års CAGR >12%, slår markedet (relativ styrke ≥0), large-cap, ≥5 års historik. Sorteret efter kvalitets-score.',
    'filters'=>['trend_r2_3y'=>['min'=>0.88],'mkt_r2_3y'=>['min'=>0.35],'rs_3y'=>['min'=>0],'cagr_3y'=>['min'=>0.12],'quality_3y'=>['min'=>0.2],'mkt_cap_usd'=>['min'=>1e9],'history_years'=>['min'=>5]]],
  'sptrackerplus' => ['label'=>'🧭 S&P-tracker+', 'sort'=>'rs_3y', 'dir'=>'desc',
    'title'=>'Markedslinket men slår indekset: stærk S&P500-korrelation (R²>0.45), jævn stigning (trend-R²>0.80), positiv relativ styrke, 3-års CAGR >8%, begrænset drawdown, large-cap. Sorteret efter merafkast vs S&P500.',
    'filters'=>['mkt_r2_3y'=>['min'=>0.45],'trend_r2_3y'=>['min'=>0.80],'rs_3y'=>['min'=>0],'cagr_3y'=>['min'=>0.08],'maxdd_3y'=>['min'=>-0.45],'mkt_cap_usd'=>['min'=>1e9]]],
